...
const u8 gBulbasaurPokedexText[] = _(
    "Það er plöntufræ á bakinu strax frá\n"
    "þeim degi sem þessi Vasaskrímsli\n"
    "fæddist. Fræið stækkar hægt og\n"
    "rólega.");

const u8 gBulbasaurPokedexTextUnused[] = _("");

const u8 gIvysaurPokedexText[] = _(
    "Það er plöntupera á bakinu. Þegar\n"
    "hún dregur í sig næringarefni er\n"
    "sagt að peran blómstra í stórt blóm.");

const u8 gIvysaurPokedexTextUnused[] = _("");

const u8 gVenusaurPokedexText[] = _(
    "Töfrandi ilmur streymir frá blóminu.\n"
    "Ilmurinn róar þá sem eru í bardaga.");

const u8 gVenusaurPokedexTextUnused[] = _("");

const u8 gCharmanderPokedexText[] = _(
    "Frá því að það fæðist logar logi í\n"
    "halaoddinum. Líf þess myndi enda ef\n"
    "loginn slokknaði.");

const u8 gCharmanderPokedexTextUnused[] = _("");

const u8 gCharmeleonPokedexText[] = _(
    "Það slær um með skottinu til að\n"
    "berja niður óvin sinn. Það rífur\n"
    "síðan upp fallna andstæðinginn með\n"
    "beittum klóm.");

const u8 gCharmeleonPokedexTextUnused[] = _("");

const u8 gCharizardPokedexText[] = _(
    "Vængirnir geta borið þennan\n"
    "Vasaskrímsli nálægt 4.600 feta hæð.\n"
    "Það slær út eld við mjög háan hita.");

const u8 gCharizardPokedexTextUnused[] = _("");

const u8 gSquirtlePokedexText[] = _(
    "Þegar það dregur langa hálsinn inn í\n"
    "skelina sprautar það vatni út af\n"
    "krafti.");

const u8 gSquirtlePokedexTextUnused[] = _("");

const u8 gWartortlePokedexText[] = _(
    "Þessi Vasaskrímsli er mjög vinsæll\n"
    "sem gæludýr. Loðklæddur halinn hans\n"
    "er tákn um langlífi hans.");

const u8 gWartortlePokedexTextUnused[] = _("");

const u8 gBlastoisePokedexText[] = _(
    "Það kreistir óvin sinn undir þungum\n"
    "líkama sínum til að valda yfirlið. Í\n"
    "smá klípu mun það draga sig inn í\n"
    "skel sína.");

const u8 gBlastoisePokedexTextUnused[] = _("");

const u8 gCaterpiePokedexText[] = _(
    "Það er þakið grænu skinni. Þegar það\n"
    "stækkar losar það húðina, hylur sig\n"
    "silki og verður að hýði.");

const u8 gCaterpiePokedexTextUnused[] = _("");

const u8 gMetapodPokedexText[] = _(
    "Jafnvel þó að það sé hjúpað í\n"
    "traustri skel er líkaminn að innan\n"
    "mjúkur. Það þolir ekki harða árás.");

const u8 gMetapodPokedexTextUnused[] = _("");

const u8 gButterfreePokedexText[] = _(
    "Vængirnir eru varðir með\n"
    "regnfráhrindandi ryki. Þess vegna\n"
    "getur þessi Vasaskrímsli flogið um\n"
    "jafnvel í rigningu.");

const u8 gButterfreePokedexTextUnused[] = _("");

const u8 gWeedlePokedexText[] = _(
    "Finnst oft í skógum og graslendi.\n"
    "Það hefur skarpan, eitraðan gadda\n"
    "sem er um það bil tvær tommur ofan á\n"
    "höfðinu.");

const u8 gWeedlePokedexTextUnused[] = _("");

const u8 gKakunaPokedexText[] = _(
    "Þessi Vasaskrímsli er á tímabundnu\n"
    "stigi á meðan hann gerir líkama\n"
    "sinn. Það er nánast algjörlega ófært\n"
    "um að hreyfa sig af sjálfu sér.");

const u8 gKakunaPokedexTextUnused[] = _("");

const u8 gBeedrillPokedexText[] = _(
    "Getur birst í kvik. Fljúga á\n"
    "ofsahraða, allt á meðan stingandi\n"
    "með eitraða stönglinum á bakinu.");

const u8 gBeedrillPokedexTextUnused[] = _("");

const u8 gPidgeyPokedexText[] = _(
    "Finnst ekki gaman að berjast. Það\n"
    "felur sig í háu grasi og svo\n"
    "framvegis, leitar að mat eins og\n"
    "litlum pöddum.");

const u8 gPidgeyPokedexTextUnused[] = _("");

const u8 gPidgeottoPokedexText[] = _(
    "Klærnar á fótunum eru vel þróaðar.\n"
    "Það getur borið bráð eins og\n"
    "SEGGALDIN í hreiðrið sitt í meira en\n"
    "60 mílna fjarlægð.");

const u8 gPidgeottoPokedexTextUnused[] = _("");

const u8 gPidgeotPokedexText[] = _(
    "Það breiðir út glæsilegu vængi sína\n"
    "víða til að hræða óvini. Það keppir\n"
    "um himininn á Mach-2 hraða.");

const u8 gPidgeotPokedexTextUnused[] = _("");

const u8 gRattataPokedexText[] = _(
    "Tennur hennar eru langar og mjög\n"
    "hvassar. Þeir stækka stöðugt, svo\n"
    "það nagar í erfiða hluti til að\n"
    "þeyta þá niður.");

const u8 gRattataPokedexTextUnused[] = _("");

const u8 gRaticatePokedexText[] = _(
    "Aftari fætur hans eru með þrjár tær\n"
    "hver. Þær eru vefjaðar sem gera því\n"
    "kleift að synda yfir ár.");

const u8 gRaticatePokedexTextUnused[] = _("");

const u8 gSpearowPokedexText[] = _(
    "Það er iðandi í gangi hér og þar.\n"
    "Jafnvel þótt það sé veikburða getur\n"
    "það verið erfiður fjandmaður sem\n"
    "notar SPEGLUN.");

const u8 gSpearowPokedexTextUnused[] = _("");

const u8 gFearowPokedexText[] = _(
    "Miklir og stórkostlegir vængir hans\n"
    "geta haldið honum á lofti. Það getur\n"
    "haldið áfram að fljúga heilan dag án\n"
    "þess að lenda.");

const u8 gFearowPokedexTextUnused[] = _("");

const u8 gEkansPokedexText[] = _(
    "Mjög algeng sjón í graslendi\n"
    "o.s.frv. Hann fletti tungunni inn og\n"
    "út til að skynja hættu í umhverfi\n"
    "sínu.");

const u8 gEkansPokedexTextUnused[] = _("");

const u8 gArbokPokedexText[] = _(
    "Mynstrið á kviðnum virðist vera\n"
    "ógnvekjandi andlit. Veikir óvinir\n"
    "munu flýja bara við að sjá mynstrið.");

const u8 gArbokPokedexTextUnused[] = _("");

const u8 gPikachuPokedexText[] = _(
    "Hann er með litla rafmagnspoka á\n"
    "báðum kinnum. Ef því er ógnað missir\n"
    "það rafhleðslur úr pokanum.");

const u8 gPikachuPokedexTextUnused[] = _("");

const u8 gRaichuPokedexText[] = _(
    "Rafhleðslur hennar geta náð jafnvel\n"
    "100.000 volt. Kærulaus snerting\n"
    "getur valdið því að jafnvel\n"
    "indverskur fíll falli í yfirlið.");

const u8 gRaichuPokedexTextUnused[] = _("");

const u8 gSandshrewPokedexText[] = _(
    "Það grafar sig og lifir neðanjarðar.\n"
    "Ef honum er ógnað hrokkar það sig\n"
    "upp í bolta sér til varnar.");

const u8 gSandshrewPokedexTextUnused[] = _("");

const u8 gSandslashPokedexText[] = _(
    "Hann er duglegur í að ráðast á með\n"
    "hryggjarlið á bakinu og beittar\n"
    "klærnar á meðan hann hlaupar hratt\n"
    "um.");

const u8 gSandslashPokedexTextUnused[] = _("");

const u8 gNidoranFPokedexText[] = _(
    "Þótt hún sé lítil þarf að fara\n"
    "varlega með hana vegna öflugra\n"
    "eitraðra gadda. Kvendýrið hefur\n"
    "minni horn.");

const u8 gNidoranFPokedexTextUnused[] = _("");

const u8 gNidorinaPokedexText[] = _(
    "Kvendýrið er skapgott. Hún gefur\n"
    "frá sér úthljóðsóp sem geta ruglað\n"
    "óvini.");

const u8 gNidorinaPokedexTextUnused[] = _("");

const u8 gNidoqueenPokedexText[] = _(
    "Líkaminn er hulinn stífum,\n"
    "nálarlíkum hreistrum. Ef hún æsist\n"
    "rísa nálarnar út á við.");

const u8 gNidoqueenPokedexTextUnused[] = _("");

const u8 gNidoranMPokedexText[] = _(
    "Stóru eyrun blakta eins og vængir\n"
    "þegar það hlustar eftir fjarlægum\n"
    "hljóðum. Það reisir eitraða gadda\n"
    "þegar það reiðist.");

const u8 gNidoranMPokedexTextUnused[] = _("");

const u8 gNidorinoPokedexText[] = _(
    "Það reiðist auðveldlega. Með því að\n"
    "sveifla vel þroskuðu horninu af\n"
    "krafti getur það jafnvel brotið í\n"
    "gegnum demant.");

const u8 gNidorinoPokedexTextUnused[] = _("");

const u8 gNidokingPokedexText[] = _(
    "Það þekkist á grjóthörðu skinninu\n"
    "og löngu horninu. Varastu hornið,\n"
    "því í því er eitur.");

const u8 gNidokingPokedexTextUnused[] = _("");

const u8 gClefairyPokedexText[] = _(
    "Sætt útlitið gerir það vinsælt sem\n"
    "gæludýr. Það er þó sjaldgæft og\n"
    "erfitt að finna.");

const u8 gClefairyPokedexTextUnused[] = _("");

const u8 gClefablePokedexText[] = _(
    "Það hefur afar næma heyrn. Það\n"
    "getur auðveldlega heyrt nál detta\n"
    "í nærri 1.100 jarda fjarlægð.");

const u8 gClefablePokedexTextUnused[] = _("");

const u8 gVulpixPokedexText[] = _(
    "Á unga aldri hefur það sex fagra\n"
    "hala. Þegar það vex spretta fram\n"
    "nokkrir nýir halar.");

const u8 gVulpixPokedexTextUnused[] = _("");

const u8 gNinetalesPokedexText[] = _(
    "Það hefur níu langa hala og feld sem\n"
    "glóir eins og gull. Sagt er að það\n"
    "lifi í 1.000 ár.");

const u8 gNinetalesPokedexTextUnused[] = _("");

const u8 gJigglypuffPokedexText[] = _(
    "Það heillar óvini með risastórum,\n"
    "kringlóttum augum og svæfir þá svo\n"
    "með róandi söng.");

const u8 gJigglypuffPokedexTextUnused[] = _("");

const u8 gWigglytuffPokedexText[] = _(
    "Feldurinn er afar fínn, þéttur og\n"
    "mjúkur. Einstaklega þægilegur\n"
    "feldurinn gefur lúxusblæ.");

const u8 gWigglytuffPokedexTextUnused[] = _("");

const u8 gZubatPokedexText[] = _(
    "Það hefur engin augu. Í staðinn\n"
    "notar það úthljóðsóp til að rata\n"
    "og flögrar um í myrkri.");

const u8 gZubatPokedexTextUnused[] = _("");

const u8 gGolbatPokedexText[] = _(
    "Það læsir sig í bráðina með\n"
    "nálarhvössum vígtönnum og sýgur\n"
    "yfir tíu únsur af blóði í einum\n"
    "teyg.");

const u8 gGolbatPokedexTextUnused[] = _("");

const u8 gOddishPokedexText[] = _(
    "Vísindanafnið er Oddium Wanderus.\n"
    "Á nóttunni er sagt að það gangi\n"
    "nærri 1.000 fet á tveimur rótum\n"
    "sínum.");

const u8 gOddishPokedexTextUnused[] = _("");

const u8 gGloomPokedexText[] = _(
    "Fræflarnir gefa frá sér ótrúlega\n"
    "vondan fnyk. Óþefurinn getur valdið\n"
    "yfirliði í 1,25 mílna fjarlægð.");

const u8 gGloomPokedexTextUnused[] = _("");

const u8 gVileplumePokedexText[] = _(
    "Krónublöðin eru þau stærstu í\n"
    "heimi. Það dreifir illkvittnislega\n"
    "ofnæmisvaldandi frjókornum úr\n"
    "blöðunum.");

const u8 gVileplumePokedexTextUnused[] = _("");

const u8 gParasPokedexText[] = _(
    "Á baki pöddunnar vaxa sveppir sem\n"
    "kallast tochukaso. Sveppirnir vaxa\n"
    "með pöddunni sem hýsir þá.");

const u8 gParasPokedexTextUnused[] = _("");

const u8 gParasectPokedexText[] = _(
    "Það dreifir eitruðum gróum úr\n"
    "svepphettunni. Í Kína eru gróin\n"
    "notuð sem jurtalyf.");

const u8 gParasectPokedexTextUnused[] = _("");

const u8 gVenonatPokedexText[] = _(
    "Augun virka eins og ratsjá og gera\n"
    "því kleift að athafna sig í myrkri.\n"
    "Augun geta líka skotið öflugum\n"
    "geislum.");

const u8 gVenonatPokedexTextUnused[] = _("");

const u8 gVenomothPokedexText[] = _(
    "Vængirnir eru þaktir ryklíku\n"
    "hreistri. Í hvert sinn sem það\n"
    "blakar vængjunum losnar mjög eitrað\n"
    "ryk.");

const u8 gVenomothPokedexTextUnused[] = _("");

const u8 gDiglettPokedexText[] = _(
    "Það grefur sig grunnt í gegnum\n"
    "jörðina. Eftir það standa eftir\n"
    "jarðhryggir sem gera auðvelt að\n"
    "koma auga á það.");

const u8 gDiglettPokedexTextUnused[] = _("");

const u8 gDugtrioPokedexText[] = _(
    "Í bardaga grefur það sig í gegnum\n"
    "jörðina og ræðst á grunlausan óvin\n"
    "úr óvæntri átt.");

const u8 gDugtrioPokedexTextUnused[] = _("");

const u8 gMeowthPokedexText[] = _(
    "Á daginn gerir það lítið annað en\n"
    "að sofa. Á nóttunni vakir það yfir\n"
    "svæði sínu með glóandi augu.");

const u8 gMeowthPokedexTextUnused[] = _("");

const u8 gPersianPokedexText[] = _(
    "Það er grimmt í skapi. Varastu ef\n"
    "það lyftir halanum beint upp. Það\n"
    "merkir að það sé að fara að stökkva\n"
    "og bíta.");

const u8 gPersianPokedexTextUnused[] = _("");

const u8 gPsyduckPokedexText[] = _(
    "Það þjáist stöðugt af höfuðverk.\n"
    "Þegar verkurinn verður mikill byrjar\n"
    "það að nota dularfulla krafta.");

const u8 gPsyduckPokedexTextUnused[] = _("");

const u8 gGolduckPokedexText[] = _(
    "Framfæturnir eru með sundfit og gera\n"
    "það að snjöllum sundkappa. Það má\n"
    "sjá synda glæsilega í vötnum og\n"
    "víðar.");

const u8 gGolduckPokedexTextUnused[] = _("");

const u8 gMankeyPokedexText[] = _(
    "Það er létt og fimt á fæti og mjög\n"
    "ofsafengið í skapi. Þegar það\n"
    "reiðist fer það í stjórnlaust æði.");

const u8 gMankeyPokedexTextUnused[] = _("");

const u8 gPrimeapePokedexText[] = _(
    "Það er alltaf tryllt af reiði. Ef\n"
    "það leggur í eltingu eltir það\n"
    "skotmarkið af þrákelkni sama hve\n"
    "langt það fer.");

const u8 gPrimeapePokedexTextUnused[] = _("");

const u8 gGrowlithePokedexText[] = _(
    "Það er mjög vinalegt og trúfast við\n"
    "fólk. Það reynir að hrekja óvini\n"
    "burt með gelti og biti.");

const u8 gGrowlithePokedexTextUnused[] = _("");

const u8 gArcaninePokedexText[] = _(
    "Vasaskrímsli sem er lýst í\n"
    "kínverskum þjóðsögum. Sagt er að\n"
    "það þjóti áfram á ótrúlegum hraða.");

const u8 gArcaninePokedexTextUnused[] = _("");

const u8 gPoliwagPokedexText[] = _(
    "Hált, svart skinnið er þunnt og\n"
    "rakt. Hluta innri líffæra má sjá í\n"
    "gegnum skinnið sem spírallaga\n"
    "mynstur.");

const u8 gPoliwagPokedexTextUnused[] = _("");

const u8 gPoliwhirlPokedexText[] = _(
    "Tveir fætur þess eru vel þroskaðir.\n"
    "Þótt það geti lifað á landi kýs það\n"
    "að lifa í vatni.");

const u8 gPoliwhirlPokedexTextUnused[] = _("");

const u8 gPoliwrathPokedexText[] = _(
    "Það er snjall sundkappi og kann\n"
    "skriðsund, flugsund og fleira. Það\n"
    "er hraðara en bestu mannlegu\n"
    "sundmenn.");

const u8 gPoliwrathPokedexTextUnused[] = _("");

const u8 gAbraPokedexText[] = _(
    "Það sefur í 18 klukkustundir á dag.\n"
    "Það notar ýmsa skynkrafta jafnvel á\n"
    "meðan það sefur.");

const u8 gAbraPokedexTextUnused[] = _("");

const u8 gKadabraPokedexText[] = _(
    "Það gerðist einn morgun að drengur\n"
    "með dulræna skynkrafta vaknaði í\n"
    "rúminu sínu umbreyttur í KÚNSTNER.");

const u8 gKadabraPokedexTextUnused[] = _("");

const u8 gAlakazamPokedexText[] = _(
    "Það er ekki hrifið af líkamlegum\n"
    "árásum. Í staðinn notar það\n"
    "dulræna skynkrafta óhindrað til að\n"
    "sigra óvini.");

const u8 gAlakazamPokedexTextUnused[] = _("");

const u8 gMachopPokedexText[] = _(
    "Allur líkaminn er úr vöðvum. Þótt\n"
    "það sé á stærð við barn getur það\n"
    "kastað 100 fullorðnum.");

const u8 gMachopPokedexTextUnused[] = _("");

const u8 gMachokePokedexText[] = _(
    "Ógnarsterkur líkaminn þreytist\n"
    "aldrei. Það hjálpar fólki með verk\n"
    "eins og að flytja þunga hluti.");

const u8 gMachokePokedexTextUnused[] = _("");

const u8 gMachampPokedexText[] = _(
    "Fjórir gríðarlega þroskaðir armar\n"
    "þess geta látið dynja yfir 1.000\n"
    "högg á aðeins tveimur sekúndum.");
...
const u8 gBellsproutPokedexText[] = _(
    ...
    "goðsagnakennd mandragóra planta.");
...
const u8 gGolemPokedexText[] = _(
    ...
    "einu sinni á ári til að stækka.");
...
const u8 gSlowpokePokedexText[] = _(
    ...
    "Það er gott í að veiða með skottinu sínu.");

const u8 gSlowpokePokedexTextUnused[] = _("");

const u8 gSlowbroPokedexText[] = _(
    "When a SLJÓN went hunting in the sea,\n"
    "its tail was bitten by a SKELSÆLL. That\n"
    "made it evolve into SLJÓNATAN.");
...
const u8 gMagnetonPokedexText[] = _(
    ...
    "SEGILL. It discharges powerful\n"
    "segulbylgjur við háspennu.");
...
const u8 gDoduoPokedexText[] = _(
    "A two-headed Vasaskrímsli that was discovered\n"
    "as a sudden mutation. It runs at a pace\n"
    "yfir 60 mílur á klukkustund.");
...
const u8 gSeelPokedexText[] = _(
    ...
    "kulda upp á mínus 40 gráður Fahrenheit.");
...
const u8 gGrimerPokedexText[] = _(
    ...
    "transformed into DRULLUPOLL. It loves feeding\n"
    "á óhreinum hlutum.");
...
const u8 gCloysterPokedexText[] = _(
    ...
    "opnast aðeins þegar það er að ráðast á.");
...
const u8 gOnixPokedexText[] = _(
    ...
    "jörðu á 50 mílur á klukkustund.");
...
const u8 gKinglerPokedexText[] = _(
    ...
    "stórt, er það óþægilegt að hreyfa.");
...
const u8 gWeezingPokedexText[] = _(
    ...
    "in two small KÍGILDI twins becoming\n"
    "conjoined as a PÚSTASKRÁP.");

const u8 gWeezingPokedexTextUnused[] = _("");

const u8 gRhyhornPokedexText[] = _(
    "Strong, but not too bright, this Vasaskrímsli\n"
...
const u8 gRhydonPokedexText[] = _(
    ...
    "grjóthnullunga með horninu sínu.");
...
const u8 gTangelaPokedexText[] = _(
    "Blue plant vines cloak the Vasaskrímsli's\n"
    "identity in a tangled mass. It entangles\n"
    "öllu sem kemst nálægt.");
...
const u8 gSeadraPokedexText[] = _(
    ...
    "að falla í yfirlið af völdum gaddanna.");
...
const u8 gStarmiePokedexText[] = _(
    "This Vasaskrímsli has a geometric body.\n"
...
const u8 gMagmarPokedexText[] = _(
    ...
    "tæplega 2.200 gráður Fahrenheit.");
...
const u8 gPinsirPokedexText[] = _(
    ...
    "sleppir ekki fyrr en óvinurinn er rifinn.");
...
const u8 gMagikarpPokedexText[] = _(
    ...
    "aumasta Vasaskrímslið í heiminum.");
...
const u8 gGyaradosPokedexText[] = _(
    ...
    "brennir algjörlega öll skotmörk.");
...
const u8 gEeveePokedexText[] = _(
    "An extremely rare Vasaskrímsli that may\n"
...
const u8 gVaporeonPokedexText[] = _(
    ...
    "Það getur bráðnað ósýnilega í vatni.");
...
const u8 gFlareonPokedexText[] = _(
    ...
    "tæplega 3.100 gráður Fahrenheit.");
...
const u8 gPorygonPokedexText[] = _(
    ...
    "first artificial Vasaskrímsli.");

const u8 gPorygonPokedexTextUnused[] = _("");

const u8 gOmanytePokedexText[] = _(
    "A prehistoric Vasaskrímsli that lived in the\n"
...
const u8 gMoltresPokedexText[] = _(
    ...
    "appelsínugula vængi sem virðast vera í ljósum logum.");
...
const u8 gMewtwoPokedexText[] = _(
    "A Vasaskrímsli whose genetic code was\n"
    "repeatedly recombined for research.\n"
    "Það varð grimmilegt í kjölfarið.");

const u8 gMewtwoPokedexTextUnused[] = _("");

const u8 gMewPokedexText[] = _(
    "A Vasaskrímsli of South America that was\n"
    "thought to have been extinct. It is very\n"
    "gáfað og lærir hvaða hreyfingu sem er.");
...
const u8 gMeganiumPokedexText[] = _(
    "LAUFJÖFUR's breath has the power to revive\n"
...
const u8 gQuilavaPokedexText[] = _(
    "This Vasaskrímsli is fully covered by\n"
    "nonflammable fur. It can withstand any\n"
    "einhvers konar eldhreyfingu.");
...
const u8 gFeraligatrPokedexText[] = _(
    ...
    "öllum fjórum. En það hreyfist hratt.");
...
const u8 gLedybaPokedexText[] = _(
    ...
    "BJALLVEIG gather from everywhere to cluster\n"
    "og halda hvor öðrum heitum.");
...
const u8 gTogepiPokedexText[] = _(
    ...
    "to anyone who can make a sleeping EGGLA\n"
    "standa upp.");
...
const u8 gNatuPokedexText[] = _(
    ...
    "greinum til að gogga í sprotana.");
...
const u8 gGligarPokedexText[] = _(
    ...
    "niður til að ráðast á.");

const u8 gGligarPokedexTextUnused[] = _("");

const u8 gSteelixPokedexText[] = _(
    "It is said that if an GRÁNAMAÐKU lives for over\n"
...
const u8 gSneaselPokedexText[] = _(
    "Vicious in nature, it drives DÚFUTETUR from\n"
...
const u8 gRemoraidPokedexText[] = _(
    ...
    "clings to a BREIÐSKATA's underside to\n"
    "leita að afgöngum.");
...
const u8 gHoundoomPokedexText[] = _(
    ...
    "Vasaskrímsli get the shivers and head straight\n"
    "aftur í hreiður sín.");
...
const u8 gKingdraPokedexText[] = _(
    ...
    "build its energy. Sagt er að það\n"
    "valdi hvirfilbyljum þegar það\n"
    "vaknar.");

const u8 gKingdraPokedexTextUnused[] = _("");

const u8 gPhanpyPokedexText[] = _(
    "Til marks um væntumþykju slær hann\n"
    "með trýninu. However, it is so\n"
    "sterkt, það gæti sent þig á flug.");

const u8 gPhanpyPokedexTextUnused[] = _("");

const u8 gDonphanPokedexText[] = _(
    "Eftir því sem tönnin eru lengri og\n"
    "stærri, því hærra er hún í\n"
    "hjörðinni. The tusks take a long\n"
    "time to grow.");

const u8 gDonphanPokedexTextUnused[] = _("");

const u8 gPorygon2PokedexText[] = _(
    "Frekari rannsóknir efldu getu þess.\n"
    "Stundum getur það sýnt hreyfingar\n"
    "sem voru ekki forritaðar.");

const u8 gPorygon2PokedexTextUnused[] = _("");

const u8 gStantlerPokedexText[] = _(
    "Þeir sem stara á horn þess munu smám\n"
    "saman missa stjórn á skynfærunum og\n"
    "geta ekki staðið.");

const u8 gStantlerPokedexTextUnused[] = _("");

const u8 gSmearglePokedexText[] = _(
    "Þegar það er orðið fullorðið hefur\n"
    "það tilhneigingu til að láta félaga\n"
    "sína planta fótspor á bakinu.");

const u8 gSmearglePokedexTextUnused[] = _("");

const u8 gTyroguePokedexText[] = _(
    "Jafnvel þó að það sé lítið, er ekki\n"
    "hægt að hunsa það vegna þess að það\n"
    "mun hleypa hvaða handhægu skotmarki\n"
    "sem er fyrirvaralaust.");

const u8 gTyroguePokedexTextUnused[] = _("");

const u8 gHitmontopPokedexText[] = _(
    "It launches kicks while spinning. Ef\n"
    "það snýst á miklum hraða getur það\n"
    "borist í jörðina.");

const u8 gHitmontopPokedexTextUnused[] = _("");

const u8 gSmoochumPokedexText[] = _(
    "Það ruggar höfðinu alltaf hægt fram\n"
    "og aftur eins og það sé að reyna að\n"
    "kyssa einhvern.");

const u8 gSmoochumPokedexTextUnused[] = _("");

const u8 gElekidPokedexText[] = _(
    "Jafnvel í illvígasta óveðrinu,\n"
    "spilar þessi Vasaskrímsli\n"
    "hamingjusamur ef þrumur dynja á\n"
    "himni.");

const u8 gElekidPokedexTextUnused[] = _("");

const u8 gMagbyPokedexText[] = _(
    "Það finnst í eldgígum. Líkamshiti\n"
    "hennar fer yfir 1.100 gráður á\n"
    "Fahrenheit, svo ekki vanmeta hann.");

const u8 gMagbyPokedexTextUnused[] = _("");

const u8 gMiltankPokedexText[] = _(
    "Ef það er nýbúið að eignast barn\n"
    "inniheldur mjólkin sem það\n"
    "framleiðir mun meiri næringu en\n"
    "venjulega.");

const u8 gMiltankPokedexTextUnused[] = _("");

const u8 gBlisseyPokedexText[] = _(
    "Það hefur mjög miskunnsamlegt eðli.\n"
    "Ef það sér veikan Vasaskrímsli mun\n"
    "það hjúkra sjúklingnum aftur til\n"
    "heilsu.");

const u8 gBlisseyPokedexTextUnused[] = _("");

const u8 gRaikouPokedexText[] = _(
    "Þessi Vasaskrímsli hleypur yfir\n"
    "landið á meðan hann geltir grát sem\n"
    "hljómar eins og þruma.");

const u8 gRaikouPokedexTextUnused[] = _("");

const u8 gEnteiPokedexText[] = _(
    "Vasaskrímsli sem keppir um landið.\n"
    "Það er sagt að maður fæðist í hvert\n"
    "sinn sem nýtt eldfjall kemur upp.");

const u8 gEnteiPokedexTextUnused[] = _("");

const u8 gSuicunePokedexText[] = _(
    "Þessi Vasaskrímsli keppir um landið.\n"
    "Það er sagt að norðanvindar muni\n"
    "einhvern veginn blása hvenær sem þær\n"
    "koma fram.");

const u8 gSuicunePokedexTextUnused[] = _("");

const u8 gLarvitarPokedexText[] = _(
    "Það fæðist djúpt neðanjarðar. Það\n"
    "getur ekki komið fram fyrr en það\n"
    "hefur alveg neytt jarðvegsins í\n"
    "kringum það.");

const u8 gLarvitarPokedexTextUnused[] = _("");

const u8 gPupitarPokedexText[] = _(
    "Jafnvel innsiglað í skelinni getur\n"
    "það hreyft sig frjálslega. Erfitt og\n"
    "hratt, það hefur framúrskarandi\n"
    "eyðileggingarmátt.");
...
const u8 gLugiaPokedexText[] = _(
    "Sagt er að það sé verndari hafsins.\n"
    "Talið er að það hafi sést á\n"
    "óveðrisnótt.");

const u8 gLugiaPokedexTextUnused[] = _("");

const u8 gHoOhPokedexText[] = _(
    "Goðsögn segir að líkami hans ljómi í\n"
    "sjö litum. Sagt er að regnbogi\n"
    "myndist fyrir aftan hann þegar hann\n"
    "flýgur.");

const u8 gHoOhPokedexTextUnused[] = _("");

const u8 gCelebiPokedexText[] = _(
    "Þegar GRÓÐURSÆLL hverfur djúpt í skógi\n"
    "er sagt að það skilji eftir sig egg\n"
    "sem það kom með úr framtíðinni.");
...
const u8 gDeoxysPokedexText[] = _(
    "Þessi SKERÐHVATI hefur breyst í sinn\n"
    "árásargjarna búning. Það getur\n"
    "blekkt óvini með því að breyta\n"
    "útliti sínu.");
