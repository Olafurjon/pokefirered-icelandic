...
static const u8 sEasyChatWord_BattleTower[] = _("BARDAGATURN");
static const u8 sEasyChatWord_Leaders[] = _("LEIÐTOGAR");
static const u8 sEasyChatWord_BattleRoom[] = _("BARDAGAHERB.");
...
static const u8 sEasyChatWord_POKEBLOCK[] = _("VASaKUBBUR");
